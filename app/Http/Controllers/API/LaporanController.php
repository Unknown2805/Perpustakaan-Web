...
class LaporanController extends Controller
{
    ...
    public function excel(Request $request  )
    {
        ...
        elseif($data > 0){
            Excel::download(new PeminjamanExport($request), 'peminjaman.xlsx');
            return response()->json([
                'pesan' => 'berhasil'
            ]);
        }
    ...
    public function excelk(Request $request )
    {
        ...
        elseif($data > 0){
            Excel::download(new PengembalianExport($request), 'pengembalian.xlsx');
            return response()->json([
                'pesan' => 'berhasil'
            ]);
        }
    ...
    public function excela(Request $request)
    {
        ...
        if($data === 0)
            ...
            {
                Excel::download(new AnggotaExport($request), 'anggota.xlsx');
                return response()->json([
                    'pesan' => 'berhasil'
                ]);
            }
