...
@php
    ...
    $pemberitahuan = Pemberitahuan::where('status','!=','nonaktif')->limit(5)->get();
...
<body style="background-image: url('{{asset('images/landing2.jpg')}}');background-position:auto;height: 80%;background-repeat: no-repeat;background-size: 100% 29%;">
    <div id="app">
              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="{{url('/admin/anggota/admin')}}">Admin</a>
                  </li>
                  <li class="submenu-item">
                    <a href="{{url('/admin/anggota/user')}}">User</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="{{url('/admin/kategori')}}">Kategori Buku</a>
                  </li>
                  <li class="submenu-item">
                    <a href="{{url('/admin/penerbit')}}">Penerbit Buku</a>
                  </li>
                  <li class="submenu-item">
                    <a href="{{url('/admin/buku')}}">Daftar Buku</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  ...
                  <li class="submenu-item">
                    <a href="{{url('/admin/pesan/keluar')}}">Pesan Keluar</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="{{url('/admin/peminjaman')}}">Peminjaman</a>
                  </li>
                  <li class="submenu-item">
                    <a href="{{url('/admin/peminjaman/pengembalian')}}">Pengembalian</a>
                  </li>
                  <li class="submenu-item">
                    <a href="{{url('/admin/anggota/laporan')}}">Anggota</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item">
                <a href="{{url('/admin/pemberitahuan')}}" class="sidebar-link">
                            ...
                            <li class="dropdown-item notification-item">
                                <a class="d-flex align-items-center" href="#">
                                    ...
                                    <div class="notification-text ms-4">
                                        <p class="notification-title font-bold">{{$p->isi_pemberitahuan}}</p>
                                    </div>
                                </a>
                            </li>
                        @endforeach
    ...
    <div class="modal-dialog">
        ...
        <form action="{{url('/admin/profile/edit/'.Auth::user()->id)}}" method="POST">
            @csrf
            @method('PUT')
